...
```bash
git clone https://github.com/<username>/rehype-cloudinary-image-size
```

Next you need to install the dependencies.

```bash
cd rehype-cloudinary-image-size
npm install
```
...
[license]: https://github.com/bradgarropy/rehype-cloudinary-image-size/blob/master/license
[fork]: https://github.com/bradgarropy/rehype-cloudinary-image-size/fork
[contributors]: https://github.com/bradgarropy/rehype-cloudinary-image-size#-contributors
